...
Current public launch line: `0.1.3`. Stable install and update examples below pin that tag explicitly.
...
```powershell
# 1) install the current beta
irm https://raw.githubusercontent.com/PerishCode/win-ctl-cli/main/scripts/manage/install.ps1 | pwsh -Command - --version v0.1.3
...
win-ctl-cli self-update --check --version v0.1.3
win-ctl-cli self-update --version v0.1.3
```
...
bash scripts/release/smoke.sh --version v0.1.3
```
...
pwsh -File scripts/release/smoke.ps1 --version v0.1.3
```
